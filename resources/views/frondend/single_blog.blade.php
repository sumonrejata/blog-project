...
<div class="event-area pt-130 pb-130">
    <div class="container">
        <div class="row">
            <div class="col-xl-9 col-lg-8">
                <div class="blog-details-wrap mr-40">
                    <div class="blog-details-top">
                        <img src="{{ asset($postdetails->image) }}" alt="">
                    ...
                    <div class="blog-author mt-80">
                        <div class="author-img">
                            <img src="{{ asset('frondend') }}/assets/img/blog/author.jpg" alt="">
                        </div>
                    ...
                    <div class="related-course pt-70">
                        ...
                        <div class="related-slider-active related-blog-slide pb-80">
                            ...
                            <div class="single-blog">
                                <div class="blog-img">
                                    <a href="#"><img src="{{ asset('frondend') }}/assets/img/blog/blog-15.jpg" alt=""></a>
                                </div>
            ...
            @include('frondend/pages/sidebar2')
