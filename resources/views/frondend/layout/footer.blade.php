                ...
                <div class="col-lg-2 col-md-6 col-sm-6">
                    <div class="footer-widget mb-40">
                        ...
                        <div class="footer-gallery">
                            <ul>
                                <li><a href="#"><img src="{{ asset('frondend') }}/assets/img/gallery/gallery-1.png" alt=""></a></li>
                                <li><a href="#"><img src="{{ asset('frondend') }}/assets/img/gallery/gallery-2.png" alt=""></a></li>
                                <li><a href="#"><img src="{{ asset('frondend') }}/assets/img/gallery/gallery-3.png" alt=""></a></li>
                                <li><a href="#"><img src="{{ asset('frondend') }}/assets/img/gallery/gallery-4.png" alt=""></a></li>
                            </ul>
                        </div>
                    </div>
                </div>
...
<script src="{{ asset('frondend') }}/assets/vendors/summernote/js/summernote-lite.min.js"></script>
<!-- Tnymc javascript -->
<script src="{{ asset('frondend') }}/assets/vendors/tnymc/tnymc.min.js"></script>
