...
<header class="header-area">
    <div class="header-top bg-img" style="background-image:url({{ asset('frondend') }}/assets/img/icon-img/header-shape.png);">
        <div class="container">
            <div class="row">
        ...
        <div class="container">
            <div class="row">
                <div class="col-lg-2 col-md-6 col-4">
                    <div class="logo">
                        <a href="index.html">
                            <img alt="" src="{{ asset('frondend') }}/assets/img/logo/logo.png">
                        </a>
                    </div>
                </div>
...
<div class="slider-area">
    <div class="slider-active owl-carousel">
        <div class="single-slider slider-height-1 bg-img" style="background-image:url({{ asset('frondend') }}/assets/img/slider/slider-1.jpg);">
            <div class="container">
                <div class="row">
                ...
                <div class="slider-single-img slider-animated-1">
                    <img class="animated" src="{{ asset('frondend') }}/assets/img/slider/single-slide-1.png" alt="">
                </div>
            </div>
        </div>
        <div class="single-slider slider-height-1 bg-img" style="background-image:url({{ asset('frondend') }}/assets/img/slider/slider-1.jpg);">
            ...
            <div class="col-lg-3 col-md-6">
                <div class="single-choose-us choose-bg-light-blue">
                    <div class="choose-img">
                        <img class="animated" src="{{ asset($list->image) }}" alt="">
                    </div>
            ...
            <div class="col-lg-6 col-md-6">
                <div class="about-content">
                    ...
                    <div class="about-btn mt-45">
                        <a class="default-btn" href="{{ $list->btnlink }}">{{ $list->btntext }}</a>
                    </div>
                </div>
            </div>
            <div class="col-lg-6 col-md-6">
                <div class="about-img default-overlay">
                    <img src="{{ asset($list->aboutimage) }}" alt="">
                    <a class="video-btn video-popup" href="{{ asset($list->videourl) }}">
                        <img class="animated" src="{{ asset('frondend') }}/assets/img/icon-img/video.png" alt="">
                    </a>
                </div>
            </div>
        </div>
...
<div class="course-area bg-img pt-130 pb-10" style="background-image:url({{ asset('frondend') }}/assets/img/bg/bg-1.jpg);">
    <div class="container">
        ...
        <div class="course-slider-active nav-style-1 owl-carousel">
            ...
            <div class="single-course">
                <div class="course-img">
                    <a href="course-details.html"><img class="animated" src="{{ asset($list->image) }}" alt=""></a>
                    @if ($list->admission)
                    <span>
                        {{ $list->admission }}
                    </span>
                ...
                <div class="course-content">
                    <h4><a href="course-details.html">{{ $list->title }}</a></h4>
                    <p>{{ $list->description }}</p>
                </div>
...
<div class="achievement-area pt-130 pb-115">
    <div class="container">
        ...
        <div class="row">    
            @foreach ($achivement as $list)
            <div class="col-xl-3 col-lg-3 col-md-6 col-sm-6">
                <div class="single-count mb-30 count-one">
                    <div class="count-img">
                        <img src="{{ asset($list->achive_image) }}" alt="">
                    </div>
                    <div class="count-content">
                        <h2 class="count">{{ $list->counter_no }}</h2>
        ...
        <div class="testimonial-slider-wrap mt-45">
            <div class="testimonial-text-slider">
                @foreach ( $testimon as $list)
                    
               
                <div class="testi-content-wrap">
                    <div class="testi-big-img">
                        <img alt="" src="{{ asset($list->testi_image) }}">
                    </div>

                   <div class="row g-0">
                       <div class="ms-auto col-lg-6 col-md-12">
                           <div class="testi-content bg-img default-overlay" style="background-image:url({{ asset('frondend') }}/assets/img/bg/testi.png);">
                                <div class="quote-style quote-left">
                                   <i class="fa fa-quote-left"></i>
                                </div>
                               <p>{{ $list->testidesc }}</p>
                                <div class="testi-info">
                                   <h5>{{ $list->testi_title }}</h5>
                                ...
                                <div class="testi-arrow">
                                    <img alt="" src="{{ asset('frondend') }}/assets/img/icon-img/testi-icon.png">
                                </div>
                           </div>
                       </div>
                   </div>
            ...
            <div class="testimonial-image-slider">
                ...
                <div class="sin-testi-image">
                    <img src="{{ asset($list->testi_image) }}" alt="">
                </div>
                @endforeach
            </div>
        </div>
        <div class="testimonial-text-img">
            <img alt="" src="{{ asset('frondend') }}/assets/img/icon-img/testi-text.png">
        </div>
    </div>
</div>


<div class="register-area bg-img pt-130 pb-130" style="background-image:url({{ asset('frondend') }}/assets/img/bg/bg-2.jpg);">
    <div class="container">
        ...
        <div class="register-wrap">
            <div id="register-3" class="mouse-bg">
                <div class="winter-banner">
                    <img src="{{ asset('frondend') }}/assets/img/banner/regi-1.png" alt="">
            ...
            <div class="row">
                <div class="col-lg-10 col-md-8">
                    <div class="register-form">
                        ...
                        <form action="{{'insertregister'}}" method="POST" enctype="multipart/form-data">
                            @csrf
                            <div class="row">
                                <div class="col-lg-6">
            ...
            <div class="custom-col-5">
                <div class="single-teacher mb-30">
                    <div class="teacher-img">
                        <img src="{{ asset($list->tea_image) }}" alt="">
                    </div>
                    <div class="teacher-content-visible">
                        <h4>{{ $list->tea_name }}</h4>
                        <h5>{{ $list->tea_desig }}</h5>
                    </div>
                    <div class="teacher-content-wrap">
                        <div class="teacher-content">
                            <h4>{{ $list->tea_name }}</h4>
                            <h5>{{ $list->tea_desig }}</h5>
                            <p>{{ $list->tea_description }}</p>
                            <div class="teacher-social">
                                <ul>
                                    <li><a class="facebook" href="#"><i class="fa fa-{{ $list->facebook }}"></i></a></li>
                                    <li><a class="youtube-play" href="#"><i class="fa fa-{{ $list->youtube }}"></i></a></li>
                                    <li><a class="twitter" href="#"><i class="fa fa-{{ $list->twitter }}"></i></a></li>
                                    <li><a class="google-plus" href="#"><i class="fa fa-{{ $list->google }}"></i></a></li>
                                </ul>
                            </div>
                        </div>
                    </div>
    ...
    <div class="container">
        ...
        <div class="event-active owl-carousel nav-style-1">
            ...
            <div class="single-event event-white-bg">
                <div class="event-img">
                    <a href="event-details.html"><img src="{{ asset($list->event_image) }}" alt=""></a>
                ...
                <div class="event-content">
                    <h3><a href="event-details.html">{{ $list->title }}</a></h3>
                    <p>{{ $list->description }}</p>
                    <div class="event-meta-wrap">
                        <div class="event-meta">
                            <i class="fa fa-location-arrow"></i>
                            <span>{{ $list->eventlocat }}</span>
                        </div>
                        <div class="event-meta">
                            <i class="fa fa-clock-o"></i>
                            <span>{!! date('g:i A', strtotime($list->created_at)) !!}</span>
                        </div>
                    </div>
                </div>
            </div>
                ...
                <div class="single-blog mb-30">
                    ...
                    <div class="blog-content-wrap">
                        ...
                        <div class="blog-content">
                            <h4><a href="{{ url('postsingle',$post->id) }}">{{ $post->title }}</a></h4>
                        ...
                        <div class="blog-date">
                            ...
                            <a href="#"><i class="fa fa-calendar-o"></i>{{ $post->created_at->format('M, jS Y') }}</a>
